...
class Finder:
    ...
    def askfindinfo(self):
        ...
        return findUser(firstname, lastname, degree, jobtitle, organization)

    def displayuserinfo(self, user):
        print "firstame: ", user.firstname, "lastname: ", user.lastname, "degree: ", user.degree,\
...
def main():
    finder = Finder ()
    u1 = User("Levon", "Mnacakanyan","PHD", "assistant", "organization2")
    u2 = User ("Lusine", "Tovmasyan", "Masters", "Lecturer", "organization1",)
